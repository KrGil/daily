package com.Eisen.daily.command_pattern.client;


import com.Eisen.daily.command_pattern.command.BathRoomLightsOnCommand;
import com.Eisen.daily.command_pattern.command.Command;
import com.Eisen.daily.command_pattern.command.LivingRoomLightsOnCommand;
import com.Eisen.daily.command_pattern.command.TerraceLightsOnCommand;
import com.Eisen.daily.command_pattern.invoker.Shiri;
